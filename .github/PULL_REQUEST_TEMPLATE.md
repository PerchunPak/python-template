...
- [ ] Я точно прочитал и использовал все пункты [этого списка](https://github.com/fire-square/fire-square-style/blob/master/CONTRIBUTING.md#перед-началом-работы).

...
- [ ] I sure, that I used all from [this list](https://github.com/{{ cookiecutter.organization }}/{{ cookiecutter.project_name }}/blob/master/CONTRIBUTING.md#before-submitting).
